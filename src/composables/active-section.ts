...
// Id of the section currently crossing a thin band at ~35–40% of the viewport
// height — exactly one section at a time since they're stacked without gaps.
// Shared observer, like scroll-hide.ts.
